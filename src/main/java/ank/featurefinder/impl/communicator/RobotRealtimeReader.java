...
2	* 2	ROBOT_MODE_BOOTING				
3	* 3	ROBOT_MODE_POWER_OFF				
4	* 4	ROBOT_MODE_POWER_ON				
5	* 5	ROBOT_MODE_IDLE				
6	* 6	ROBOT_MODE_BACKDRIVE				
7	* 7	ROBOT_MODE_RUNNING				
8	* 8 ROBOT_MODE_UPDATING_FIRMWARE	
	 */
  public Double getRobotMode() {
    Double Robotmode = RealtimeMessage[RTinfo.robotmode.index()];
	System.out.println("Robot mode is "+Robotmode);
