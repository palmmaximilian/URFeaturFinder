package ank.featurefinder;

public abstract class DefaultVariables {

  // ProbeFeatureClass

  public static String DefaultPose="p[0,0,0,0,0,0]";
  public static int DefaultForce=8;

  public static double DefaultProbeSpeed=20;
